...
INSERT INTO `activity` VALUES (7,'2013-11-28','例会','曹溪公园',0,0,'例会',1,'海湾'),(8,'2013-12-18','例会','曹溪公园',0,0,'例会',1,'海湾'),(9,'2014-10-28','例会','宜山路',0,0,'例会',1,'海湾'),(10,'2014-12-28','例会','宜山路',0,0,'例会',1,'海湾'),(11,'2015-02-20','例会','joy',0,0,'例会',1,'海湾'),(12,'2015-02-27','例会','joy',0,0,'例会',1,'海湾'),(14,'2015-07-25','例会','joy',0,0,'',1,'云中'),(17,'2015-08-01','例会','joy',0,0,'',1,'云中'),(18,'2015-08-08','例会','joy',0,0,'',1,'云中'),(19,'2015-08-09','例会','joy',0,0,'',1,'云中'),(20,'2015-08-15','例会','joy',0,0,'',1,'海湾');
...
CREATE TABLE `activity_record` (
  ...
  KEY `account` (`account`),
  CONSTRAINT `activity_record_ibfk_2` FOREIGN KEY (`account`) REFERENCES `user` (`account`),
  CONSTRAINT `activity_record_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`)
...
CREATE TABLE `dance` (
  ...
  PRIMARY KEY (`name`),
  KEY `country` (`country`),
  CONSTRAINT `dance_ibfk_1` FOREIGN KEY (`country`) REFERENCES `country` (`name`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dance` VALUES ('26号公寓','以色列',2,3,'',2),('Sax Man','未知',1,5,'出自：自编。',2),('Suddently','未知',1,2,'出自：以。',2),('Sunny Day','未知',1,1,'出自：。',0),('TicoTico','以色列',2,2,'',3),('一千夜','未知',1,1,'出自：。',0),('一把情种','未知',1,3,'出自：台湾山地。',0),('一舞定情','美国',2,3,'',0),('万物之始','以色列',1,3,'',1),('三世情缘','未知',1,1,'出自：。',0),('三月桃花','未知',2,1,'出自：台.自编。',1),('上路','以色列',2,2,'',2),('不老林','以色列',1,1,'',0),('与我同唱','以色列',1,2,'',0),('世外桃源','未知',1,1,'出自：台湾山地。',0),('丝路之旅','中国',1,3,'',0),('两情相悦','以色列',1,4,'',0),('中国探戈','未知',2,1,'出自：。',2),('中欧少女','匈牙利',1,3,'',1),('丰年海洋之歌','未知',1,1,'出自：台湾山地。',0),('为你欢唱','以色列',1,3,'',0),('为我欢唱','未知',1,1,'出自：。',2),('为爱情干杯','未知',1,2,'出自：新自编。',1),('乌克兰小品','未知',1,3,'出自：俄国。',1),('也爵克','未知',2,2,'出自：自编。',1),('也许是爱','未知',2,3,'出自：台湾。',0),('乡愁','未知',1,1,'出自：。',0),('五彩缤纷','未知',2,4,'出自：探戈。',1),('亚罗曼之音','罗马尼亚',1,2,'',0),('亚营呼拉','以色列',1,2,'',0),('亚隆狄不开','以色列',1,4,'',0),('仗鼓舞','韩国',1,1,'',2),('以我全心','以色列',1,3,'',1),('以色列歌手','以色列',1,1,'',0),('以色列茉莉','以色列',1,2,'',2),('以色列马则卡','以色列',2,2,'',1),('伊娜伊娜','未知',1,1,'出自：。',1),('伊斯潘诺扇子舞','未知',1,5,'出自：现代芭蕾。',1),('伊甸园','以色列',2,2,'',0),('伊莎拉','未知',1,1,'出自：。',0),('优雅的女士','未知',1,1,'出自：亚。',0),('伴你同行','以色列',2,4,'',0),('低调探戈','未知',2,3,'出自：自编。',1),('佐巴','以色列',1,1,'',0),('何日君再来','未知',1,1,'出自：。',0),('你很美丽','以色列',2,2,'',0),('俄罗斯之茶','未知',1,5,'出自：俄罗斯。',0),('俪影探戈','未知',2,3,'出自：探戈。',1),('假日圆舞曲','未知',2,3,'出自：华尔兹。',1),('停不了','以色列',1,3,'',0),('光明在望','以色列',1,3,'',0),('八音盒舞者','未知',2,3,'出自：自编。',0),('关岛颂','关岛',1,2,'',1),('再续情缘','以色列',2,2,'',0),('再见','未知',1,1,'海湾传统结束舞',2),('农家子弟','罗马尼亚',1,3,'',1),('冬季到台北看雨','未知',1,2,'出自：现代。',1),('凝眸','以色列',1,3,'',0),('凡格里探戈','未知',2,1,'出自：探戈。',0),('凯瑟琳华士','未知',2,2,'出自：华尔兹。',1),('击鞋兰德勒','奥地利',2,4,'',0),('刀剑如梦','中国',1,3,'',1),('初恋情人','未知',1,1,'出自：。',1),('别让我心碎','未知',1,1,'出自：。',0),('北爱琴海之音','未知',1,1,'出自：希。',1),('千里之外','未知',1,3,'出自：扇子。',1),('午夜狂欢','以色列',1,2,'',1),('华尔兹宫廷舞','未知',2,3,'出自：华尔兹。',0),('南美午夜探戈','未知',2,3,'出自：探戈。',0),('南都夜曲','未知',1,1,'出自：。',0),('卡布里岛','未知',1,3,'出自：探戈。',0),('卡罗索','未知',1,3,'出自：华尔兹。',1),('卡马伦斯卡','未知',2,5,'出自：俄国。',0),('只在以色列','以色列',1,2,'',0),('只想与你共舞','未知',2,1,'出自：。',0),('可爱的森巴','以色列',2,3,'',0),('台湾好','未知',1,3,'出自：台湾山地。',0),('吉普赛姑娘','以色列',2,4,'',0),('吉普赛披巾舞','未知',1,1,'出自：。',0),('吉普赛狂欢','罗马尼亚',1,4,'',0),('吉普赛玫瑰','美国',1,3,'',0),('名家帕索','西班牙',2,4,'',1),('听吧!以色列','以色列',1,2,'',0),('听泉','未知',1,3,'出自：。',0),('告别华尔滋','未知',2,1,'出自：欧。',2),('周末晚上','美国',1,2,'',0),('呼唤','未知',1,1,'出自：。',1),('哈萨匹克莫扎特','希腊',1,2,'',0),('哥伦比亚假期','未知',1,1,'出自：。',0),('哥萨克雪球树','未知',1,2,'出自：俄国。',0),('唐山子民','未知',1,4,'出自：现代国舞。',0),('啼鸟','以色列',2,3,'',0),('困惑','以色列',2,2,'',1),('国王之歌','未知',1,1,'出自：。',1),('圆桌武士','匈牙利',1,3,'',0),('土耳其之吻','以色列',1,3,'',0),('土耳其呼啦','未知',1,2,'出自：土耳其。',1),('土耳其婚礼舞','未知',1,1,'出自：土。',0),('圣临','未知',1,1,'出自：。',1),('圣诞铃声','未知',1,1,'出自：自编。',0),('在游逛场上','以色列',1,2,'',1),('坚信不移','以色列',1,3,'',0),('夏夜','未知',1,1,'出自：。',1),('夏威夷情歌','未知',1,3,'出自：夏威夷。',1),('夏日之末','以色列',2,2,'',0),('多美丽','以色列',1,1,'',0),('多阿狄不开','未知',1,3,'出自：。',0),('夜半歌声','以色列',1,2,'',0),('夜玫瑰','以色列',2,2,'',2),('大东京音头','日本',1,1,'',1),('大众之歌','以色列',2,3,'',0),('大巡行','以色列',1,3,'',0),('大法师','以色列',1,3,'',2),('大灰狼与小红帽','未知',1,1,'出自：。',0),('大花轿','中国',2,2,'',0),('天与地','以色列',1,4,'',0),('天堂','以色列',1,3,'',1),('天天年轻','未知',1,3,'出自：自编。',1),('奥地利风光','奥地利',2,2,'',0),('奥贝雷克','波兰',2,3,'',1),('女鼓手','以色列',1,2,'',0),('威尼华士','未知',2,5,'出自：华尔兹。',1),('婆锡尼沙Poseniica','保加利亚',1,2,'',1),('学生王子','德国',2,1,'',1),('宁静海','未知',2,2,'出自：。',0),('宝岛曼波','未知',2,1,'出自：自编。',0),('客栈风情画','以色列',1,2,'',1),('寇西卡','未知',2,4,'出自：华尔兹。',0),('寻梦舞No.1','波兰',2,2,'',0),('寻梦舞No3','波兰',2,3,'',0),('小村婚礼','未知',1,1,'出自：。',0),('小淘气','未知',1,2,'出自：爵士。',0),('小茶店','未知',2,3,'出自：。',0),('小马车','以色列',1,2,'',1),('少女约葳','保加利亚',1,5,'',0),('就是爱跳舞','未知',1,1,'出自：。',1),('就是现在','以色列',1,3,'',0),('就要挥别','中国',2,2,'',0),('山地情歌','未知',1,1,'出自：台湾山地。',0),('巴康之歌','未知',2,1,'出自：自编。',0),('巴斯克山谷','西班牙',1,4,'',0),('巴比伦塔','未知',1,2,'出自：。',1),('帆船','以色列',1,3,'',0),('希望之树','未知',1,1,'出自：。',1),('希腊情歌','希腊',2,2,'',0),('希腊水手','希腊',1,4,'',1),('帕索帕索','西班牙',2,4,'',0),('帛拉','未知',1,1,'出自：。',0),('年轻不要留白','未知',1,4,'出自：台湾自编。',0),('幸福人生','以色列',1,3,'',0),('康乃馨','保加利亚',1,1,'',0),('张开你的眼','以色列',1,3,'',0),('弦歌探戈','未知',2,1,'出自：探戈。',0),('弯曲的圆环','未知',1,4,'出自：保。',0),('归乡','以色列',1,3,'',0),('归来之歌','未知',1,1,'出自：日。',0),('归来的游子','以色列',1,2,'',0),('当那枫叶红','未知',2,2,'出自：台湾。',0),('彩云之南','未知',1,5,'出自：傣族。',0),('征兵','未知',1,4,'出自：匈。',0),('微不足道','以色列',2,3,'',1),('微醺的午后','以色列',2,2,'',1),('心中梦中','未知',2,2,'出自：。',1),('心想事成','以色列',1,3,'',0),('快乐恰恰','保加利亚',1,4,'',0),('快乐水手','美国',2,2,'',1),('怀念老歌','以色列',2,3,'',0),('恰恰恰','未知',2,3,'出自：自编。',1),('悦耳的音符','未知',1,2,'出自：以。',0),('悲伤嫉妒','未知',1,2,'出自：自编。',1),('情歌恰恰','未知',2,2,'出自：恰恰。',0),('情毒','以色列',1,3,'',0),('愉快的舞者','罗马尼亚',1,1,'',1),('意大利顽童','意大利',1,1,'',1),('感动','以色列',2,3,'',0),('慕情','美国',2,4,'',0),('慕罗薛伯','未知',1,3,'出自：罗.吉。',1),('戈兰高地','未知',1,1,'出自：。',0),('戴维王','以色列',1,1,'',1),('所罗门王的光辉','以色列',1,1,'',0),('扇子手巾舞','菲律宾',2,2,'',0),('手足情深','以色列',1,1,'',0),('手足欢聚','以色列',1,2,'',0),('托罗潘卡','未知',1,2,'出自：保。',1),('拉丁旋律','未知',2,3,'出自：恰恰。',0),('拉丁美洲之夜','未知',2,1,'出自：。',0),('拉荷儿','未知',2,2,'出自：。',0),('拿坡里手鼓舞','意大利',2,3,'',0),('捍卫祖国','以色列',1,3,'',0),('探戈伊斯康地诺','未知',2,2,'出自：探戈。',1),('探戈回想曲','以色列',2,1,'',1),('探戈探戈','未知',2,4,'出自：探戈。',1),('探戈舞会','未知',2,4,'出自：探戈。',0),('摇摆舞会','巴西',1,2,'',1),('放手','未知',1,3,'出自：。',1),('故乡的女孩','未知',1,2,'出自：中.自编。',0),('散步舞','美国',1,1,'',0),('斯卡狄布开','以色列',1,2,'',1),('方形探戈','未知',2,2,'出自：探戈。',1),('旅程','印度',1,5,'',1),('日出日落','美国',2,4,'',0),('日本人的拖鞋','美国',2,2,'',0),('星与花','以色列',2,3,'',0),('春之维也纳','未知',2,4,'出自：华尔兹。',0),('春之花','以色列',2,3,'',1),('春日时光','亚美尼亚',1,2,'',0),('春雾之恋','未知',1,1,'出自：。',1),('暗夜','以色列',2,4,'',0),('最后一夜','未知',2,4,'出自：华尔兹。',1),('最后华士','未知',2,2,'出自：华尔兹。',1),('月光小语','未知',1,1,'出自：。',1),('月光曲','未知',1,1,'出自：。',0),('月桃花','未知',1,3,'出自：自编。',0),('月琴','未知',1,2,'出自：现代.自编。',0),('木船','以色列',1,1,'',0),('未停','以色列',2,3,'',0),('杜鹃圆舞曲','未知',2,4,'出自：华尔兹。',0),('来吧.苏珊娜','未知',1,3,'出自：以。',0),('枫叶飘飘','美国',2,3,'',0),('柔情','以色列',2,3,'',1),('格拉夫斯卡.力沙','未知',1,3,'出自：保。',0),('格拉欧斯克NO.1','南斯拉夫',1,4,'',1),('桑塔雷塔','墨西哥',2,3,'',1),('梦中的妈妈','未知',1,2,'出自：新自编。',0),('梦幻巴黎','未知',2,4,'出自：探戈。',0),('梭罗河畔','印度尼西亚',2,3,'',1),('欢迎光临','以色列',1,3,'',0),('欧耶莎莎','未知',2,1,'出自：莎莎。',0),('歌','以色列',1,2,'',2),('歌与甜酒','未知',2,3,'出自：华尔兹。',0),('每年','以色列',1,3,'',0),('水汪汪','中国',2,1,'',1),('水舞','以色列',1,1,'',0),('水色华士','未知',2,3,'出自：华尔兹。',0),('池畔舞影','未知',2,4,'出自：华尔兹。',0),('沙漠儿女','未知',2,2,'出自：中.自编。',0),('沙漠幻影','未知',1,2,'出自：。',0),('法兰西华士','未知',2,2,'出自：华尔兹。',1),('法国香水','以色列',2,3,'',0),('法拉弗','以色列',2,2,'',0),('波斯地毯','以色列',1,1,'',0),('泰国欢乐舞','未知',1,4,'出自：自编。',1),('泰山','希腊',1,3,'',1),('洛哈地','以色列',2,1,'',1),('活力四射','以色列',1,2,'',0),('浓情蜜意','以色列',2,2,'',0),('浪迹天涯','未知',2,4,'出自：台湾自编。',0),('海亚','未知',1,1,'出自：。',1),('海兰快舞','未知',1,3,'出自：苏格兰。',1),('海滩慕情','菲律宾',2,3,'',1),('海韵','未知',2,3,'出自：华尔兹。',1),('海龙之歌','未知',2,3,'出自：。',1),('深情相拥','未知',1,4,'出自：自编。',0),('深情难忘','未知',2,3,'出自：探戈。',1),('温泉山庄','未知',1,2,'出自：。',0),('激情莎莎','以色列',2,4,'',0),('火星攻击','美国',1,2,'',0),('烈火青春','未知',1,4,'出自：爵士。',1),('烛光与香水','以色列',2,2,'',1),('热舞啦啦啦','未知',1,4,'出自：爵士。',0),('爱人琴娜蕊','以色列',2,3,'',1),('爱在风中蔓延时','以色列',2,3,'',1),('爱尔兰探戈','未知',2,3,'出自：探戈。',1),('爱情万岁','以色列',1,3,'',2),('爱情斥侯兵','以色列',2,2,'',0),('爱无止尽','未知',2,2,'出自：。',2),('爱的光芒','以色列',2,4,'',2),('爱的期盼','以色列',2,1,'',0),('爱的渴望','美国',2,3,'',0),('爵士','未知',1,3,'出自：爵士。',0),('牛奶蜜糖','以色列',1,3,'',0),('牡丹花冠','未知',1,1,'出自：。',1),('牧场游戏','未知',1,3,'出自：。',1),('牧羊人之歌','以色列',1,2,'',0),('狂欢节扑克','未知',2,4,'出自：自编。',1),('玫瑰玫瑰我爱你','未知',1,2,'出自：自编。',0),('玫瑰花丛','未知',2,3,'出自：华尔兹。',1),('珍惜','以色列',1,2,'',0),('珠曼阿铁克','以色列',1,1,'',0),('甘美拉','以色列',1,1,'',1),('生命之扉','未知',1,1,'出自：。',1),('田纳西假发舞','美国',2,1,'',0),('田纳西华士','未知',2,1,'出自：华尔兹。',0),('白色的秋天','以色列',2,3,'',0),('白鸽','未知',2,1,'出自：。',1),('皇后来了','以色列',1,2,'',0),('相思比梦长','中国',1,2,'',0),('真善美','奥地利',2,3,'',0),('短暂相聚','以色列',2,4,'',1),('祈祷','以色列',1,2,'',1),('童年','中国',2,1,'',0),('笑咪咪','未知',1,1,'出自：。',1),('米歇尔','以色列',1,3,'',0),('红睡莲','未知',2,1,'出自：台湾自编。',1),('细说从头','以色列',1,1,'',1),('维洲之音','美国',2,2,'',0),('罗拉探戈','未知',2,3,'出自：探戈。',1),('美丽的夜','以色列',2,2,'',1),('美丽的大地','以色列',1,2,'',0),('美丽的神话','未知',2,3,'出自：现代。',0),('美就是心中有爱','以色列',1,3,'',2),('美忆','未知',2,2,'出自：自编。',0),('美拉美拉','未知',1,4,'出自：自编。',0),('翠堤春晓','中国',2,5,'',0),('翠提菩提','未知',1,1,'出自：。',0),('考验','以色列',1,3,'',0),('脚踏车华士','未知',2,3,'出自：华尔兹。',0),('舞会','以色列',1,3,'',0),('舞在桌上','未知',1,3,'出自：以。',2),('舞影翩翩','未知',2,2,'出自：华尔兹。',0),('艺术家生涯','未知',2,4,'出自：华尔兹。',2),('花之旋律','未知',1,1,'出自：。',1),('花之语','未知',2,2,'出自：华尔兹。',0),('苏珊娜','以色列',2,3,'',0),('苏穆基女郎','匈牙利',1,3,'',0),('苦恋','以色列',2,3,'',0),('苹果','希腊',1,1,'',1),('苹果树下','未知',2,1,'出自：俄罗斯。',1),('苹果西打','美国',2,1,'',1),('草原倾诉','未知',1,4,'出自：保。',0),('荷塘月色','未知',1,3,'出自：。',0),('莉亚','以色列',1,3,'',1),('莎拉恰恰','未知',2,4,'出自：恰恰。',0),('莫希雅','以色列',1,3,'',1),('菊花台','未知',1,1,'出自：。',0),('落魄的游民','以色列',2,3,'',1),('蓝色别墅','未知',2,2,'出自：台湾。',0),('蓝色多恼河A','未知',2,5,'出自：华尔兹。',2),('蓝色探戈','未知',2,4,'出自：探戈。',0),('蕾丝裙','中国',2,2,'',0),('血染的风釆','未知',1,3,'出自：台湾。',0),('行云流水','未知',1,1,'出自：保。',0),('裸足天使','以色列',1,3,'',0),('西班牙之心','以色列',2,3,'',2),('西班牙进行曲','西班牙',2,3,'',0),('西维拉娜斯A','西班牙',2,4,'',1),('诗情画意','未知',2,2,'出自：自编。',0),('诗般的梦幻','未知',2,3,'出自：华尔兹。',0),('谁是幸运儿','未知',1,2,'出自：罗.吉。',1),('谜','以色列',1,3,'',0),('豪华华士','未知',2,3,'出自：华尔兹。',1),('贝壳小语','未知',1,1,'出自：。',0),('贝西斯男子舞','未知',1,1,'出自：。',0),('跳舞街','未知',1,3,'出自：港.自编。',0),('辣妹子','未知',1,1,'出自：。',1),('达布卡鼓','未知',1,1,'出自：。',0),('迷途的小鸟','意大利',1,2,'',0),('追忆','未知',1,2,'出自：排湾族。',0),('那乐','未知',1,1,'出自：亚。',0),('那玛小姐','以色列',2,3,'',1),('邵族迎宾舞','未知',1,1,'出自：台湾山地。',0),('金山恋','未知',1,1,'出自：。',1),('金巴拉','罗马尼亚',1,4,'',1),('金玉盟','以色列',1,1,'',1),('金粉梦河','未知',2,2,'出自：。',0),('金色华士','未知',1,2,'出自：华尔兹。',0),('银线','未知',1,1,'出自：。',0),('锁上记忆','以色列',2,4,'',0),('锦衣还乡','未知',1,4,'出自：自编。',0),('问天','未知',1,1,'出自：。',1),('阿拉伯英雄','以色列',1,1,'',0),('阿拉木汗','未知',2,1,'出自：中.自编。',2),('阿根廷探戈','未知',2,4,'出自：探戈。',2),('阿路娜','罗马尼亚',1,1,'',0),('阿达娜','未知',1,1,'出自：亚。',1),('阿里郎','韩国',1,1,'',2),('难忘的今天','未知',2,2,'出自：华尔兹。',0),('难舍难分','未知',2,2,'出自：。',0),('雅各布的袜丝','以色列',1,1,'',1),('雅歌','以色列',1,2,'',0),('雅蒂娜','以色列',2,3,'',0),('雨中旋律','美国',2,2,'',1),('雨中行','未知',2,2,'出自：。',0),('雨夜花','未知',1,1,'出自：中.自编。',0),('雷安耶男子舞No1','匈牙利',1,5,'',0),('韵律人生','未知',2,4,'出自：。',0),('预兆','以色列',2,3,'',1),('风之采','未知',2,4,'出自：现代芭蕾。',0),('风吹风吹','未知',1,1,'出自：台湾自编。',0),('风声','以色列',1,3,'',0),('风流寡妇','未知',2,2,'出自：自编。',1),('飞吧.梦想','未知',1,1,'出自：自编。',0),('马尼夏莉','未知',1,1,'出自：。',0),('马来情歌','马来西亚',2,3,'',0),('驼峰','以色列',1,4,'',0),('高傲的少女','以色列',1,4,'',0),('高潮','以色列',2,3,'',1),('鲁卡','保加利亚',1,5,'',2),('黄丝带','美国',1,1,'',1),('黄昏','以色列',1,3,'',0),('黑池探戈','未知',2,3,'出自：探戈。',1),('黑猫探戈','未知',2,3,'出自：探戈。',0),('黑眼睛','未知',2,1,'出自：亚。',0),('黑眼睛的女孩','亚美尼亚',1,2,'',1),('黛绿年华','未知',2,2,'出自：。',2),('齐罗鲁兰德勒','德国',2,4,'',1),('龙之家族','以色列',2,3,'',0),('龙飞凤舞','未知',2,3,'出自：吉鲁巴。',1);
...
CREATE TABLE `dance_record` (
  ...
  PRIMARY KEY (`id`),
  KEY `activity_id` (`activity_id`),
  CONSTRAINT `dance_record_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`)
...
INSERT INTO `pay_record` VALUES (1,'海湾','2015-08-11 17:38:30',0,'例会场地老板','例会场地费');
...
-- Dump completed on 2015-08-14 14:27:36
